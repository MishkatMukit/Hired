        ...
        <div className='max-w-[90%] mx-auto py-10 '>
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    <motion.div
                        className='max-w-xl shadow-lg rounded-xl p-5 border border-secondary  hover:bg-green-100 transition-bg duration-500'>
                ...
                <motion.div
                    variants={itemVariants}
                    className='p-5 mt-5  shadow-lg rounded-xl border border-secondary hover:bg-green-100 transition-bg duration-500'>
